...
OPENAI_API_ENDPOINTS = {
    ...
    "send_otp_passwordless": "https://auth.openai.com/api/accounts/passwordless/send-otp",
...
OPENAI_PAGE_TYPES = {
    ...
    "PASSWORD_REGISTRATION": "password",  # 旧页面类型：新账号/登录需要密码步骤
    "PASSWORD_REGISTRATION_ALT": "create_account_password",  # 新页面类型别名
    "LOGIN_PASSWORD": "login_password",  # 登录页密码挑战
}
